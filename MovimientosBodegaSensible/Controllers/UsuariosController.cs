...
using MovimientosBodegaSensible.Servicios;
using System.Data;
...
namespace MovimientosBodegaSensible.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        private readonly MovimientosParisContext context;

        public UsuariosController(UserManager<IdentityUser> userManager,
            SignInManager<IdentityUser> signInManager, MovimientosParisContext context)
        {
